...
import MaintenancePlans from '@/pages/inventory/maintenance/MaintenancePlans'
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/">
          ...
          <Route path="inventario/mantenimiento/planes" element={<RequirePermission permiso="inventario.mantenimiento"><MaintenancePlans /></RequirePermission>} />
