  ...
  return (
    <PageLayout title="Captura de Lectura">
      <div className="space-y-6">
        ...
        {visit.fecha_programada > new Date().toLocaleDateString('en-CA') && (
          <div className="rounded-md bg-amber-50 border border-amber-200 text-amber-700 px-3 py-2 text-sm flex items-start gap-2">
            <AlertTriangle className="h-4 w-4 mt-0.5 shrink-0" />
            <span>
              Visita adelantada: está programada para el {formatDate(visit.fecha_programada)}. Si el
              cliente no corresponde a esta visita, reprograma o crea una nueva.
            </span>
          </div>
        )}
