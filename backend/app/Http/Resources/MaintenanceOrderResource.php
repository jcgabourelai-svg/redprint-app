    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'plan' => $this->whenLoaded('plan', fn () => $this->plan === null ? null : [
                'id' => $this->plan->id,
                'printer_model_id' => $this->plan->printer_model_id,
                'printer_id' => $this->plan->printer_id,
                'periodicidad_meses' => $this->plan->periodicidad_meses,
                'periodicidad_paginas' => $this->plan->periodicidad_paginas,
            ]),
